...
class Model:
    def __init__(self,
        ...
        # my added variables
        self.h1 = 5  # conv2d1 out_channel
        self.h2 = 4  # conv2d2 out_channel
    ...
    def forward(self, is_train, reuse=False):

        with tf.variable_scope("model", reuse=reuse):
            # TODO: implement input -- Conv -- BN -- ReLU -- Dropout -- MaxPool -- Conv -- BN -- ReLU -- Dropout -- MaxPool -- Linear -- loss
            #        the 10-class prediction output is named as "logits"
            # Your Conv Layer
            conv1 = tf.layers.conv2d(self.x_, filters=self.h1, kernel_size=[3, 3], strides=[1, 1],
            ...
            # Your Conv Layer
            conv2 = tf.layers.conv2d(maxpool1, filters=self.h2, kernel_size=[3, 3], strides=[1, 1],
                                     padding="SAME", kernel_initializer=tf.truncated_normal_initializer(stddev=0.1))
            # Your BN Layer: use batch_normalization_layer function
            ...
            # Your Linear Layer
            reshape2 = tf.reshape(maxpool2, [-1, 7*7*self.h2])
